...
if __name__ == '__main__':
    ...
    if MODE == "Play":
        ...
        optimizer = torch.optim.Adam(network.parameters(), lr=0)
        ...
        # Memory relative
        REPLAY_MEMORY = 8192
        BEGIN_LEARN_SIZE = 2048 # This should be smaller than `REPLAY_MEMORY` to start learning
        ...
        # Epsilon relatife
        BEGIN_EPSILON = 0 #0.15
        epsilon = BEGIN_EPSILON
        FINAL_EPSILON = 0 #0.003 # Smallest epsilon
        EXPLORE = 45000 # Controlling the epsilon
