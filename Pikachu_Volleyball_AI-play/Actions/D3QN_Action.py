...
class Dueling_D3QN(nn.Module):
    def __init__(self, action_dim):
        ...
        if STATE_MODE == "gray_scale":
            ...
            torch.nn.init.normal_(self.conv1.weight, 0, 0.002)
            torch.nn.init.normal_(self.conv2.weight, 0, 0.002)
            torch.nn.init.normal_(self.conv3.weight, 0, 0.002)
            torch.nn.init.normal_(self.val_hidden.weight, 0, 0.002)
            torch.nn.init.normal_(self.val.weight, 0, 0.002)
            torch.nn.init.normal_(self.adv_hidden.weight, 0, 0.002)
            torch.nn.init.normal_(self.adv.weight, 0, 0.002)
